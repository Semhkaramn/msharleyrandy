...
# (tag_exclusion_service.py'den taşındı)
# ============================================
...
async def set_user_taggable(group_id: int, telegram_id: int, is_taggable: bool) -> tuple:
    """
...
async def add_excluded_user_by_input(group_id: int, user_input: str) -> tuple:
    """
...
async def remove_excluded_user(group_id: int, telegram_id: int) -> tuple:
    """
